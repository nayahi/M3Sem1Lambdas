...
Deploy-Lambda `
    ...
    -Environment @{
        # Semana 1: S3 y bucket
        S3_ENDPOINT = "http://localstack:4566"
        REPORTS_BUCKET = "reports-generated"
        # Semana 3: Redis cache
        REDIS_ENDPOINT = "redis:6379"
        CACHE_TTL_SECONDS = "600"
        # Semana 4: Secrets Manager (REEMPLAZA SQL_CONNECTION_STRING hardcodeado)
        SECRETS_ENDPOINT = "http://localstack:4566"
        SQL_SECRET_NAME = "ecommerce/sql-connection"
        # Semana 4: JWT - Issuer esperado de Keycloak
        JWT_ISSUER = "http://keycloak:8080/realms/ecommerce"
        # Semana 4: Fallback (solo si Secrets Manager no responde)
        SQL_CONNECTION_STRING = "Server=sqlserver,1433;User Id=sa;Password=Password123!;TrustServerCertificate=True;"
    } `
    -Memory 1024 `
    -Timeout 120 `
    -Description "Genera reportes PDF - Sem4: Secrets Manager + Audit Log + JWT"
